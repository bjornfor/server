...
use OCA\Files_Versions\Db\Version;
use OCP\IDBConnection;
use OCP\AppFramework\Db\QBMapper;

/**
 * @extends QBMapper<Version>
 */
class VersionsMapper extends QBMapper {
	public function __construct(IDBConnection $db) {
		parent::__construct($db, 'files_versions', Version::class);
	}
	...
	public function findVersionForFileId(int $fileId, int $timestamp): Version {
		$qb = $this->db->getQueryBuilder();
